    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_member', models.BooleanField(default=True, help_text='会员', verbose_name='会员')),
        ...
        migrations.AddField(
            model_name='address',
            name='consumer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='关联消费者'),
        ),
        migrations.AddField(
            model_name='address',
            name='district',
