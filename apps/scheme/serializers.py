...
from apps.product.serializers import ProductListSerializers
from .models import *
...
class SchemeDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Scheme
        exclude = ['views', 'download_count', 'consumer']
...
class SchemeDetailPageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Scheme
        fields = ['title','price','code_name','desc_specific','images','download_count','source_web']
